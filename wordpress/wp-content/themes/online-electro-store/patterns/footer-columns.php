...
<div class="wp-block-columns alignwide footer-box wow bounceInUp" style="padding-top:0px;padding-right:15px;padding-bottom:0px;padding-left:15px"><!-- wp:column {"width":"30%","className":"footer-contact-box","style":{"spacing":{"blockGap":"24px"}}} -->
