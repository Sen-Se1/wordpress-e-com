		...
		<div class="right-main-box">
			<div class="right-inner">
				<div class="pro-boxes">
					...
					<p><?php esc_html_e('60+ Premium WordPress Themes', 'online-electro-store'); ?></p>
					<p class="main-bundle-price" ><strong class="cancel-bundle-price"><?php esc_html_e('$2340', 'online-electro-store'); ?></strong><span class="bundle-price"><?php esc_html_e('$86', 'online-electro-store'); ?></span></p>
				...
				<div class="pro-boxes pro-theme-container">
					...
					<p class="pro-theme-price" ><?php esc_html_e('$39', 'online-electro-store'); ?></p>
					...
					<a href="<?php echo esc_url( ONLINE_ELECTRO_STORE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Upgrade To Pro At Just at $29.25', 'online-electro-store'); ?></a>
				</div>
